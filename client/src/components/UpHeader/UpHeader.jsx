    ...
    return (
        <div className={classes.upHeader}>
            <div className={classes.upHeader_container}>
                ...
                <div className={classes.upHeader_container_Raspisanie}><span className={classes.span_info}>пн-пт 9:00-18:00</span> <span className={classes.span_info}>сб-вс 9:00-16:00</span> </div>
